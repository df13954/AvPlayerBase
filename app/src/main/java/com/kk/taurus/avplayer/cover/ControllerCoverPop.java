...
public class ControllerCoverPop extends BaseCover implements OnTimerUpdateListener, OnTouchGestureListener {
    ...
    public ControllerCoverPop(Context context) {
        super(context);
    }
    ...
    public void onTimerUpdate(int curr, int duration, int bufferPercentage) {
        ...
        if (stateGetter != null) {
            int state = stateGetter.getState();
            /**
             * int STATE_END = -2;
             *     int STATE_ERROR = -1;
             *     int STATE_IDLE = 0;
             ...
             */
            Log.i(TAG, "onTimerUpdate: state :" + state + "");
        }
        updateUI(curr, duration);
    }

    private void updateUI(int curr, int duration) {
        // Log.i("->>", "onTimerUpdate: " + curr);
        // Log.i("->>", "onTimerUpdate: " + duration);
        // Log.i("->>", "------------------: ");
    ...
    public View onCreateCoverView(Context context) {
        return View.inflate(context, R.layout.layout_controller_cover_pop, null);
    }
