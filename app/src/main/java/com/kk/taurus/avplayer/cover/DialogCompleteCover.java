...
public class DialogCompleteCover extends BaseCover {

    private TextView mReplay;

    public DialogCompleteCover(Context context) {
        super(context);
    }
    ...
    public View onCreateCoverView(Context context) {
        return View.inflate(context, R.layout.layout_dialog_complete_cover, null);
    }
