...
public class PopCompleteCover extends BaseCover {

    private TextView mReplay;
    private TextView mTvTest;

    public PopCompleteCover(Context context) {
        super(context);
    }
    ...
    public void onReceiverBind() {
        ...
        mTvTest.setOnClickListener(mOnClickListener);
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.tv_replay:
                    ...
                    break;
                case R.id.tv_test:
                    if (mITestCallBack != null) {
                        mITestCallBack.openTest();
                    }
                    break;
            }
        }
    ...
    public View onCreateCoverView(Context context) {
        return View.inflate(context, R.layout.layout_pop_complete_cover, null);
    }
